...
`colorist` can be used to visualize mutliple years of distribution data in a single map.
...
Alternatively, it can be used to visualize data covering different times in a single year.
