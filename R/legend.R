...
#' Make an HCL legend for a map containing a cyclical sequence of distributions
#'
...
#' Make an HCL legend for a map containing a linear sequence of distributions
#'
#' @description This function creates a legend to accompany a map describing
...
#' # create legend for palette
#' legend_timeline(pal)
legend_timeline <- function(palette, specificity = TRUE, time_labels = NULL, return_df = FALSE) {
...
#' Make an HCL legend for a map containing an unordered set of distributions
#'
#' @description This function creates a legend to accompany a map describing
...
#'   [palette_groups].
#' @param specificity logical indicating whether to visualize intensity
#'   and layer information for the full range of potential specificity values (i.e., 0-100) or
#'   for a single specificity value (i.e., 100). Typically, a single specificity
#'   value is appropriate for [map_multiples] visualizations.
...
#'   - `layer_id`: integer identifying the layer containing the maximum
#'   intensity value; mapped to hue.
#'   - `color`: - `color`: the hexadecimal color associated with the given layer and
#'   specificity values.
#'   - `intensity`: maximum cell value across layers divided by the maximum
#'   value across all layers and cells; mapped to alpha level.
#'
